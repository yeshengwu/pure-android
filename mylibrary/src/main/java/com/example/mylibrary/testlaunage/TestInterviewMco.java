...
//        String ddd = new String("abc");
        ...
        System.out.println("strFromChars = " + strFromChars + " strFromChars == ddd? " + (strFromChars == ddd));
        System.out.println("ddd.hashCode = " + ddd.hashCode() + " strFromChars.hashCode() = " + strFromChars.hashCode());

        change(ddd, chars);
        System.out.println("str = " + ddd + " chars = " + Arrays.toString(chars));
        System.out.println("after change strFromChars = " + strFromChars); // 是否会被影响？ 结果不影响，见 String(chars[]) api 描述

        // 对象情况下  调用 change() 是变的
        Person aPerson = new Person("oldName");
        System.out.println("before change: aPerson = " + aPerson);
        change_obj(aPerson);
        System.out.println("after change: aPerson = " + aPerson);
    }
